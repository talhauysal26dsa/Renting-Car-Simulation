...
//For simulation We created 3 while loops for each Customer, Car, and Day.	
		...
		while(!customers.isEmpty()) {
			...
			while(!(customers.isEmpty())&&!(v>entryNumberCar)) {
				...
				System.out.print("\n");
				System.out.print("Current"+ " "+car+" quality="+car.getQuality()+" " +"is offering to"+"\n");
				...
				while((!accepted)&&!(m>entryNumber)){
					...
					if (customer.getThreshold()<=car.getQuality()) {
						...
						accepted = true;
						System.out.print("\t"+ "Current"+ " "+ customer +" threshold="+customer.getThreshold()+ "   accepted"+  "\n");
					...
					//if rejected
						...
						System.out.print("\t"+"Current"+ " "+ customer +" threshold="+customer.getThreshold()+ "   not accepted"+"\n");
						m++;
